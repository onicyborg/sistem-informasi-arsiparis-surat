...
<head>
    ...
    <title>Sistem Informasi Arsiparis Surat</title>
    <!-- Simple bar CSS -->
        ...
        <div class="row align-items-center h-100">
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="/login" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="username" name="username" id="inputUsername" class="form-control form-control-lg"
                ...
                <div class="checkbox mb-3">
                    <label>
                        <input type="checkbox" name="remember_me" value="remember-me"> Stay logged in </label>
                </div>
