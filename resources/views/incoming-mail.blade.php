    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <p>Data Keseluruhan Surat Diterima</p>
                ...
                <div class="card shadow mb-3">
                    <div class="card-body">
                        <h5 class="card-title">Filter Tanggal (berdasarkan tanggal surat diterima)</h5>
                        <form id="filterForm" action="/incoming-mail" method="GET">
                            <div class="form-row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                    <label>&nbsp;</label>
                                    <a href="/incoming-mail" class="btn btn-primary btn-block">Reset Filter</a>
                                </div>
                            </div>
                        </form>
                    </div>
                                        ...
                                        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/incoming-letter-update/{{ $item->id }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    ...
                                                                    value="{{ $item->tanggal_diterima }}" required>
                                                            </div>
                                                            <div class="form-group">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="/incoming-letter-delete/{{ $item->id }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
        ...
        <div class="modal fade" id="addSuratModal" tabindex="-1" role="dialog" aria-labelledby="addSuratModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/incoming-letter-store" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="pengirim">Pengirim</label>
